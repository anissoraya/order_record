...
class ChefOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chef_order" do
    assert_difference('ChefOrder.count') do
      post chef_orders_url, params: { chef_order: { chef_id: @chef_order.chef_id, order_id: @chef_order.order_id } }
    end
  ...
  test "should update chef_order" do
    patch chef_order_url(@chef_order), params: { chef_order: { chef_id: @chef_order.chef_id, order_id: @chef_order.order_id } }
